...
import 'package:assessment_app/questions/Q24.dart';
...
class TestPageState extends State<Q23> {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton.icon(
                    onPressed: () async {
                      AudioPlayer().play(AssetSource('/recording/23.wav'));
                    },
