...
import 'package:assessment_app/questions/Q5.dart';
...
class TestPageState extends State<Q4> {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton.icon(
                    onPressed: () async {
                      AudioPlayer().play(AssetSource('/recording/4.wav'));
                    },
