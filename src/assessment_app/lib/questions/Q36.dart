...
import 'package:assessment_app/questions/Q37.dart';

class Q36 extends StatefulWidget {
  const Q36({super.key});
...
class TestPageState extends State<Q36> {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton.icon(
                    onPressed: () async {
                      AudioPlayer().play(AssetSource('/recording/36.wav'));
                    },
