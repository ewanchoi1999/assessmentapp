...
import 'package:assessment_app/questions/Q14.dart';
...
class TestPageState extends State<Q13> {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      color: isSelected[3] ? Colors.blue : Colors.transparent,
                    ),
                    child: Image.asset(
                      'assets/images/fat3.png',
                      fit: BoxFit.contain,
                      height: 250,
                      width: 250,
                    ),
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton.icon(
                    onPressed: () async {
                      AudioPlayer().play(AssetSource('/recording/13.wav'));
                    },
