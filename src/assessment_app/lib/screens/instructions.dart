...
import 'package:assessment_app/screens/instructions2.dart';
...
class Instructions extends State<Instruction> {
  ...
  void playaudio() async {
    await player.play(AssetSource('recording/0.wav'));
    await Future.delayed(const Duration(seconds: 10));
    await player2.play(AssetSource('recording/0a.wav'));
  }
